...
if CLIENT then
  ...
  local function ComposeBar(x, y, w, h, colour, start, body, endi, v, off)
    ...
    -- HOLOHUD:DrawTextureUV(start, x + EXT_OFFSET, y, sW, h, 0, 0, sW/EXT_WIDTH, 1, colour, not off);
    ...
    -- local bW = math.Clamp(width - (EXT_REAL_WIDTH + EXT_OFFSET), 0, bodyWidth);
